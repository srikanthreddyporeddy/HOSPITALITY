        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li><a href=""onclick="popup()">Service</a></li>
				<li><a href=""onclick="popup()">Doctors</a></li>
				<li><a href=""onclick="popup()">Facilities</a></li>
				<li><a href=""onclick="popup()">Pricing</a></li>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<a href=""onclick="popup()">	<input type="submit" value="Submit" class="btn btn-skin btn-block btn-lg"></a>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="wow lightSpeedIn" data-wow-delay="0.1s">
										<div class="cta-btn">
										<a href=""onclick="popup()"" class="btn btn-skin btn-lg">Book an appoinment</a>	
										</div>
									</div>
								</div>
							</div>
